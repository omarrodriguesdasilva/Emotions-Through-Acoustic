##
## a fonte deste código é dataset_loader.py
##
...
class DatasetLoader:
    ...
    def compose_complete_dataset(self):
        ...
        return X, y
    # translate_emotion - alterado Omar - 21/04/2022
    ...
    def get_dataset(self):
        ...
        for file_path in file_paths:
            #try:
                ...
                # Inicio - Alteração Omar.
                # print('dataset_path:', self.dataset_path)
                if self.dataset_path in ("datasets/Original/MFCC", "datasets/Original/Prosody"):
                    inst2 = inst.iloc[0:, 3:]
                else:
                    inst2 = inst.iloc[0:, 2:]
    ...
    # get_extra_info - alterado Omar - 21/04/2022
