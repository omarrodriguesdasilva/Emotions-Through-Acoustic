...
# Alterado em 31/12/2023 para incluir no MidTermFeatures_omar a alteração do os.sep para "/"
# o padrão de nome recuperado do sistema operacional é "/".
# O os.sep é o separator do sistema operacional e, ao executar sob windows, retorna "\".
# Neste caso, a rotina em execução dá erro pois grava no arquivo MODEL o nome das classes junto com o diretório.
# Não executa o comando split.
...
def extract_features_and_train(paths, mid_window, mid_step, short_window,
    ...
    # Alterado por Omar - 17/12/2022 para incluir a performance
    best_param, best_perf = evaluate_classifier(features, class_names, classifier_type,
...
def feature_extraction_train_regression(folder_name, mid_window, mid_step,
    ...
    """
    # STEP A: Feature Extraction:
    # Alterado em 31/12/2023 devido a alteração do MidTermFeatures_omar
    # features, _, filenames = \
    features, _, filenames, _ = \
...
def evaluate_classifier(features, class_names, classifier_name, params,
    ...
    ## incluido Omar - 17/12/2022
    best_ac = np.amax(ac_all)
    best_f1 = np.amax(f1_all)
    ## incluido Omar - fim
    ...
    if parameter_mode == 0:
        ...
        return params[best_ac_ind], best_ac
        ...
        return params[best_f1_ind], best_f1
